...
(() => {
  ...
  // src/components/Hotkey.jsx
  var _tmpl$2 = /* @__PURE__ */ template(`<label for=RButtonAndWheel_Select>: `);
  var _tmpl$22 = /* @__PURE__ */ template(`<select class=selectList>`);
  var _tmpl$32 = /* @__PURE__ */ template(`<div><div class=title_div><span class=title_inline><span class=numberRow>. </span></span></div><div class=desc></div><div class=modsContainer>`);
  var _tmpl$42 = /* @__PURE__ */ template(`<option>`);
  function Hotkey(props) {
    return (() => {
      var _el$ = _tmpl$32(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$2.nextSibling, _el$10 = _el$6.nextSibling;
      insert(_el$4, () => props.index, _el$5);
      insert(_el$3, () => props.item.title, null);
      insert(_el$, createComponent(Show, {
        ...
        get children() {
          return [(() => {
            ...
            insert(_el$7, () => props.item.list.desc, _el$8);
            return _el$7;
          })(), " ", (() => {
            var _el$9 = _tmpl$22();
            _el$9.addEventListener("change", (e) => props.selectEvent(props.item.id, e));
            insert(_el$9, createComponent(For, {
              get each() {
                return props.item.list.items;
              },
              children: (item, index) => (() => {
                var _el$11 = _tmpl$42();
                insert(_el$11, () => item.display);
                createRenderEffect(() => _el$11.selected = props.item.list.value == item.function ? "selected" : "");
                createRenderEffect(() => _el$11.value = item.function);
                return _el$11;
              })()
            }));
            createRenderEffect((_p$) => {
              var _v$ = props.item.function + "_Select", _v$2 = props.item.function + "_Select";
              _v$ !== _p$.e && setAttribute(_el$9, "name", _p$.e = _v$);
      ...
      insert(_el$10, createComponent(Show, {
        get when() {
          return props.item.hotkeyDisplay;
        },
        get children() {
          return createComponent(Form$1.Control, {
            ...
            get onChange() {
              return [props.hotkeyChangeEvent, props.item.id];
            }
          });
        }
      }), null);
      insert(_el$10, createComponent(Form$1.Check, {
        "class": "switch",
        type: "switch",
        get checked() {
          return props.item.isEnable ? "checked" : "";
        },
        get onChange() {
          return [props.toggleEnableEvent, props.item.id];
        }
      }), null);
      createRenderEffect((_p$) => {
        var _v$3 = props.item.isEnable ? "hotkeyDiv" : "hotkeyDiv hotkeyDiv_disable", _v$4 = props.item.desc;
        _v$3 !== _p$.e && className(_el$, _p$.e = _v$3);
        _v$4 !== _p$.t && (_el$6.innerHTML = _p$.t = _v$4);
        return _p$;
      }, {
        e: void 0,
        t: void 0
  ...
  function parseHotkeyString(hotkeyStr) {
    ...
    hotkeyStr = hotkeyStr.replace(/\+/gi, "|");
    let modObj = {};
    Object.keys(hotkeySymbolReplaceMap).forEach(function(key2, index) {
      const regex = new RegExp(key2, "i");
      let modMatchResult = hotkeyStr.match(regex);
      if (modMatchResult) {
        modObj[key2] = hotkeySymbolReplaceMap[key2];
        const regex2 = new RegExp(key2 + "[|]*", "i");
        hotkeyStr = hotkeyStr.replace(regex2, "");
      }
    });
  ...
  var [hotkeys, setHotkeys] = createSignal([]);
  function HotkeyList() {
    ...
    function isHotkeyExist(testHotkey) {
      ...
      for (const [index, item] of Object.entries(itemList)) {
        ...
        if (item.hotkeyDisplay.toLowerCase() === testHotkey.hotkeyDisplay.toLowerCase() && item.scope && testHotkey.scope && item.scope.toLowerCase() === testHotkey.scope.toLowerCase()) {
    ...
    const hotkeyChangeEvent = async (id, event) => {
      ...
      if (item === false) {
        ...
        setHotkeys(hotkeys().map((item2) => item2.id !== id ? item2 : newHotkey));
        sendToAhk_updateHotkey(id);
      } else {
        event.target.value = prevHotkey.hotkeyDisplay;
        setModalText('This hotkey "' + item.index + ". " + item.title + '" already exists.');
        setShowModal(true);
      }
    };
    const selectEvent = async (id, event) => {
      ...
      setHotkeys(hotkeys().map((item) => item.id !== id ? item : newHotkey));
      sendToAhk_updateHotkey(id);
    };
    const toggleEnableEvent = (id) => {
      setHotkeys(hotkeys().map((item) => item.id !== id ? item : {
        ...item,
    ...
    return [createComponent(Modal$12, {
      get show() {
        return showModal();
      },
      onHide: closeModal,
      get children() {
        return [createComponent(Modal$12.Header, {
          closeButton: true,
          get children() {
            return createComponent(Modal$12.Title, {
              children: "Warning"
            });
          }
        }), createComponent(Modal$12.Body, {
          get children() {
            return modalText();
          }
        }), createComponent(Modal$12.Footer, {
          get children() {
      ...
      children: (item, index) => createComponent(Hotkey_default, {
        item,
        get index() {
          return index() + 1;
        },
  ...
  var HotkeyList_default = HotkeyList;

  // src/components/HotkeyAliases/HotkeyAlias.jsx
  var _tmpl$6 = /* @__PURE__ */ template(`<input class=hotkeyAlias type=text maxlength=100 name=hotkeyDisplay>`);
  var _tmpl$23 = /* @__PURE__ */ template(`<span class=aliasArrow>\u2794`);
  var _tmpl$33 = /* @__PURE__ */ template(`<input class=hotkeyAlias type=text maxlength=100 name=aliasDisplay>`);
  var _tmpl$43 = /* @__PURE__ */ template(`<span class=aliasArrow>Scope:`);
  var _tmpl$52 = /* @__PURE__ */ template(`<input class=hotkeyAlias type=text maxlength=100 name=scope>`);
  var _tmpl$62 = /* @__PURE__ */ template(`<div><div class=title_div><span class=title_inline><span class=numberRow>.</span></span></div><div class=desc></div><div class=modsContainer><div class=switch><span class=delete title=Delete><svg xmlns=http://www.w3.org/2000/svg width=16 height=16 fill=currentColor class="bi bi-trash3-fill"viewBox="0 0 16 16"><path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5">`);
  function HotkeyAlias(props) {
    return (() => {
      var _el$ = _tmpl$62(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$2.nextSibling, _el$7 = _el$6.nextSibling, _el$13 = _el$7.firstChild, _el$14 = _el$13.firstChild, _el$15 = _el$14.firstChild;
      insert(_el$4, () => props.index, _el$5);
      insert(_el$3, () => props.item.title, null);
      insert(_el$7, createComponent(Show, {
        ...
        get children() {
          return [(() => {
            var _el$8 = _tmpl$6();
            _el$8.addEventListener("change", (e) => props.hotkeyChangeEvent(props.item.id, e));
            createRenderEffect(() => setAttribute(_el$8, "id", "hotkeyHotkey-" + props.item.id));
            createRenderEffect(() => _el$8.value = props.item.hotkeyDisplay);
            return _el$8;
          })(), _tmpl$23(), (() => {
            var _el$10 = _tmpl$33();
            _el$10.addEventListener("change", (e) => props.hotkeyChangeEvent(props.item.id, e));
            createRenderEffect(() => setAttribute(_el$10, "id", "hotkeyAlias-" + props.item.id));
            createRenderEffect(() => _el$10.value = props.item.aliasDisplay);
            return _el$10;
          })(), _tmpl$43(), (() => {
            var _el$12 = _tmpl$52();
            _el$12.addEventListener("change", (e) => props.hotkeyChangeEvent(props.item.id, e));
            createRenderEffect(() => setAttribute(_el$12, "id", "hotkeyAliasScope-" + props.item.id));
            createRenderEffect(() => _el$12.value = props.item.scope);
            return _el$12;
          })()];
        }
      }), _el$13);
      _el$15.$$click = props.deleteEvent;
      _el$15.$$clickData = props.item.id;
      insert(_el$13, createComponent(Form$1.Check, {
        type: "switch",
        get checked() {
          return props.item.isEnable ? "checked" : "";
        },
      ...
      createRenderEffect((_p$) => {
        var _v$ = props.item.isEnable ? "hotkeyDiv" : "hotkeyDiv hotkeyDiv_disable", _v$2 = props.item.desc;
        _v$ !== _p$.e && className(_el$, _p$.e = _v$);
        _v$2 !== _p$.t && (_el$6.innerHTML = _p$.t = _v$2);
        return _p$;
      }, {
        e: void 0,
        t: void 0
  ...
  var HotkeyAlias_default = HotkeyAlias;
  delegateEvents(["click"]);

  // src/components/HotkeyAliases/AddAlias.jsx
  var _tmpl$7 = /* @__PURE__ */ template(`<div class=hotkeyDiv><form id=addAliasForm><div class=title_div>Title:<input class=hotkeyAlias type=text id=addAlias_title style=width:400px maxlength=100></div><div class=modsContainer><input class=hotkeyAlias type=text id=addAlias_from maxlength=100 placeholder=Hotkey><input class=hotkeyAlias type=hidden id=addAlias_from_hotkey maxlength=100 placeholder=Hotkey><span class=aliasArrow>\u2794</span><input class=hotkeyAlias type=text id=addAlias_to maxlength=100 placeholder=Alias><input class=hotkeyAlias type=hidden id=addAlias_to_hotkey maxlength=100 placeholder=Alias><span class=aliasArrow>Scope:</span><input class=hotkeyAlias type=text id=addAlias_scope maxlength=100>`);
  function AddAlias(props) {
    return (() => {
      var _el$ = _tmpl$7(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
      addEventListener(_el$2, "submit", props.addAliasSubmitEvent);
  ...
  var AddAlias_default = AddAlias;

  // src/functions/functions.js
  var modReplaceMapAbs = {
    LCtrl: "^",
    LControl: "^",
    Ctrl: "^",
    RControl: "^",
  ...
  function parseHotkeyString2(hotkeyStr) {
    hotkeyStr = hotkeyStr.replace(/ /gi, "");
    hotkeyStr = hotkeyStr.replace(/\+/gi, "|");
    let modObj = {};
    Object.keys(modReplaceMapAbs).forEach(function(key2, index) {
      const regex = new RegExp(key2, "i");
      let modMatchResult = hotkeyStr.match(regex);
      if (modMatchResult) {
        modObj[key2] = modReplaceMapAbs[key2];
        const regex2 = new RegExp(key2 + "[| ]*", "i");
        hotkeyStr = hotkeyStr.replace(regex2, "");
      }
    });
  ...
  // src/components/HotkeyAliases/HotkeyAliases.jsx
  var _tmpl$8 = /* @__PURE__ */ template(`<div class=mb-1>Here you can assign an alias to the hotkey. <br>In the field on the left - the real hotkey must be specified. In the field on the right - the alias, that the real hotkey will press.<br>For example, to switch the language to English, this hotkey is assigned in Windows - <kbd>Ctrl+Shift+9</kbd>.<br>And this hotkey assigned to switch the language to Another language - <kbd>Ctrl+Shift+8</kbd>.<br>These hotkeys are not convenient to press.<br>It is much more convenient to press - <kbd>Ctrl+F9</kbd>, <kbd>Ctrl+F8</kbd>. But in Windows you can not assign these hotkeys.<br>Because of this, we assign these aliases (<kbd>Ctrl+F9</kbd>, <kbd>Ctrl+F8</kbd>).<br>To assign hotkeys for switching between languages, you need to go to <kbd>Windows Settings</kbd> - <kbd>Win+I</kbd>. Then type <kbd>Typing</kbd> in the search, and select <kbd>Typing Settings</kbd>. Then <kbd>Advanced keyboard settings</kbd>. Then click the link at the bottom - <kbd>Input language hotkeys</kbd>. A window with languages \u200B\u200B\u200B\u200Bwill open. <br>Click the <kbd>Change Key Sequence</kbd> button, and assign there for the English language - hotkey <kbd>Ctrl+Shift+9</kbd>, and for Another Language - <kbd>Ctrl+Shift+8</kbd>. (You do not need to assign hotkeys like <kbd>Ctrl+8</kbd>, due to conflicts).<br>And then just turn on the hotkeys below here: <kbd>Set English</kbd>, and <kbd>Set Language 2</kbd> (turn on the switch on the right).<br><br><b>Note:</b> The <kbd>Scope</kbd> field - is the hotkey's scope. For example, if you specify <kbd>CabinetWClass</kbd> here, the hotkey will only work in the FileExplorer window.`);
  var [hotkeyAliases, setHotkeyAliases] = createSignal([]);
  var [isShowAddAliasForm, setIsShowAddAliasForm] = createSignal(false);
  function HotkeyAliases() {
    const deleteEvent = (id) => {
      setHotkeyAliases(hotkeyAliases().filter((item) => item.id !== id));
      sendToAhk_deleteHotkeyAliases(id);
    };
    const toggleEnableEvent = (id) => {
      setHotkeyAliases(hotkeyAliases().map((item) => item.id !== id ? item : {
        ...item,
        isEnable: !item.isEnable
      }));
    ...
    const hotkeyChangeEvent = (id, event) => {
      ...
      if (name === "hotkeyDisplay") {
        ...
        let [hotkeyDisplay, hotkeyHotkey, key_] = parseHotkeyString2(value);
        hotkeyHotkey += "{" + key_ + "}";
        setHotkeyAliases(hotkeyAliases().map((item) => item.id !== id ? item : {
          ...item,
          hotkeyDisplay,
      ...
      if (name === "aliasDisplay") {
        ...
        let [aliasDisplay, aliasHotkey, key_] = parseHotkeyString2(value);
        aliasHotkey += key_;
        setHotkeyAliases(hotkeyAliases().map((item) => item.id !== id ? item : {
          ...item,
          aliasDisplay,
    ...
    const addAliasSubmitEvent = (event) => {
      ...
      let [hotkeyDisplay, hotkeyHotkey, key_] = parseHotkeyString2(alias.hotkeyDisplay);
      ...
      let [hotkeyDisplay2, hotkeyHotkey2, key_2] = parseHotkeyString2(alias.aliasDisplay);
    ...
    return [_tmpl$8(), createComponent(For, {
      get each() {
        return hotkeyAliases();
      },
      children: (item, index) => createComponent(HotkeyAlias_default, {
        item,
        get index() {
          return index() + 1;
        },
      ...
      get when() {
        return isShowAddAliasForm();
      },
      get children() {
        return createComponent(AddAlias_default, {
          addAliasSubmitEvent
        });
      }
  ...
  var HotkeyAliases_default = HotkeyAliases;

  // src/components/HotkeyDisabled/HotkeyDisabled.jsx
  var _tmpl$9 = /* @__PURE__ */ template(`<input class=hotkeyAlias type=text maxlength=100 name=hotkeyDisplay>`);
  var _tmpl$24 = /* @__PURE__ */ template(`<span class=aliasArrow>Scope:`);
  var _tmpl$34 = /* @__PURE__ */ template(`<input class=hotkeyAlias type=text maxlength=100 name=scope>`);
  var _tmpl$44 = /* @__PURE__ */ template(`<div><div class=title_div><span class=title_inline><span class=numberRow>.</span></span></div><div class=desc></div><div class=modsContainer><div class=switch><span class=delete title=Delete><svg xmlns=http://www.w3.org/2000/svg width=16 height=16 fill=currentColor class="bi bi-trash3-fill"viewBox="0 0 16 16"><path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5">`);
  function HotkeyDisabled(props) {
    return (() => {
      var _el$ = _tmpl$44(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$2.nextSibling, _el$7 = _el$6.nextSibling, _el$11 = _el$7.firstChild, _el$12 = _el$11.firstChild, _el$13 = _el$12.firstChild;
      insert(_el$4, () => props.index, _el$5);
      insert(_el$3, () => props.item.title, null);
      insert(_el$7, createComponent(Show, {
        get when() {
        ...
        get children() {
          return [(() => {
            var _el$8 = _tmpl$9();
            _el$8.addEventListener("change", (e) => props.hotkeyChangeEvent(props.item.id, e));
            createRenderEffect(() => setAttribute(_el$8, "id", "hotkeyDisabled-" + props.item.id));
            createRenderEffect(() => _el$8.value = props.item.hotkeyDisplay);
            return _el$8;
          })(), _tmpl$24(), (() => {
            var _el$10 = _tmpl$34();
            _el$10.addEventListener("change", (e) => props.hotkeyChangeEvent(props.item.id, e));
            createRenderEffect(() => setAttribute(_el$10, "id", "hotkeyDisabledScope-" + props.item.id));
            createRenderEffect(() => _el$10.value = props.item.scope);
            return _el$10;
          })()];
        }
      }), _el$11);
      _el$13.$$click = props.deleteEvent;
      _el$13.$$clickData = props.item.id;
      insert(_el$11, createComponent(Form$1.Check, {
        type: "switch",
        get checked() {
          return props.item.isEnable ? "checked" : "";
        },
  ...
  var HotkeyDisabled_default = HotkeyDisabled;
  delegateEvents(["click"]);

  // src/components/HotkeyDisabled/AddHotkeyDisabled.jsx
  var _tmpl$10 = /* @__PURE__ */ template(`<div class=hotkeyDiv><form id=addAliasForm><div class=title_div>Title:<input class=hotkeyAlias type=text id=addHotkeyDisabled_title style=width:400px maxlength=100></div><div class=modsContainer><input class=hotkeyAlias type=text id=addHotkeyDisabled name=hotkeyDisplay maxlength=100 placeholder="Hotkey to disable"><span class=aliasArrow>Scope:</span><input class=hotkeyAlias type=text id=addHotkeyDisabled_scope name=scope maxlength=100 title="Ahk_class of the application for which to disable the hotkey">`);
  function AddHotkeyDisabled(props) {
    return (() => {
      var _el$ = _tmpl$10(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
      addEventListener(_el$2, "submit", props.addDisabledHotkeySubmitEvent);
      insert(_el$2, createComponent(Button$12, {
        type: "submit",
        "class": "mt-4",
        style: {
  ...
  var AddHotkeyDisabled_default = AddHotkeyDisabled;

  // src/components/HotkeyDisabled/HotkeysDisabled.jsx
  var _tmpl$11 = /* @__PURE__ */ template(`<div class=mb-1>Hotkeys that need to be disabled.<br>Required if there is a hotkey that can cause problems and it needs to be disabled. To eliminate accidental pressing.<br>For example, there is a hotkey in File Explorer - <kbd>Ctrl+D</kbd>. If you accidentally press this hotkey, the selected file will be silently deleted.<br>This hotkey is not needed, it is dangerous, and therefore it is better to disable it. Then when you press this hotkey, nothing happens.<br><br><b>Note:</b> The <kbd>Scope</kbd> field - is the hotkey's scope. For example, if you specify <kbd>CabinetWClass</kbd> here, the hotkey will only work in the FileExplorer window.`);
  var [hotkeyDisabled, setHotkeyDisabled] = createSignal([]);
  var [isShowAddForm, setIsShowAddForm] = createSignal(false);
  function HotkeysDisabled() {
    const deleteEvent = (id) => {
      setHotkeyDisabled(hotkeyDisabled().filter((item) => item.id !== id));
      sendToAhk_deleteHotkeyDisabled(id);
    };
    const toggleEnableEvent = (id) => {
      setHotkeyDisabled(hotkeyDisabled().map((item) => item.id !== id ? item : {
        ...item,
        isEnable: !item.isEnable
      }));
    ...
    return [_tmpl$11(), createComponent(For, {
      get each() {
        return hotkeyDisabled();
      },
      children: (item, index) => createComponent(HotkeyDisabled_default, {
        item,
        get index() {
          return index() + 1;
        },
      ...
      get children() {
        return createComponent(AddHotkeyDisabled_default, {
          addDisabledHotkeySubmitEvent
        });
      }
    }), createComponent(Button$12, {
      "class": "mb-4",
      ...
      variant: "success",
      onClick: addDisabledHotkeyEvent,
      children: "Add Disabled hotkey"
    })];
  }
  var HotkeysDisabled_default = HotkeysDisabled;

  // src/components/ConfirmModal.jsx
  var [modalOkCancel, setModalOkCancel] = createSignal({
    isShow: false,
    text: "",
    choseEvent: {}
  });
  ...
  function ConfirmModal() {
    return createComponent(Modal$12, {
      get show() {
        return modalOkCancel().isShow;
      },
      onHide: () => modalOkCancel_chose(false),
      get children() {
        return [createComponent(Modal$12.Header, {
          closeButton: true
        }), createComponent(Modal$12.Body, {
          get children() {
            return modalOkCancel().text;
          }
        }), createComponent(Modal$12.Footer, {
          get children() {
            return [createComponent(Button$12, {
              variant: "secondary",
              onClick: () => modalOkCancel_chose(false),
              children: "Cancel"
            }), createComponent(Button$12, {
              variant: "primary",
              onClick: () => modalOkCancel_chose(true),
              children: "OK"
            })];
          }
        })];
  ...
  // src/App.jsx
  var _tmpl$12 = /* @__PURE__ */ template(`<h2>Aliases`);
  var _tmpl$25 = /* @__PURE__ */ template(`<h2>Disabled hotkeys`);
  var configInit = {};
  var resetToDefaultHotkeysClick = (e) => {
  ...
  var [config, setConfig] = createSignal(configInit);
  function App() {
    onMount(async () => {
    });
    return [createComponent(ConfirmModal_default, {}), createComponent(HotkeyList_default, {}), createComponent(Button$12, {
      "class": "mb-4",
      style: {
        "margin-right": "auto",
        "display": "block"
      ...
      variant: "success",
      onClick: resetToDefaultHotkeysClick,
      children: "Reset to default hotkeys"
    }), _tmpl$12(), createComponent(HotkeyAliases_default, {}), _tmpl$25(), createComponent(HotkeysDisabled_default, {})];
  }
  var App_default = App;
