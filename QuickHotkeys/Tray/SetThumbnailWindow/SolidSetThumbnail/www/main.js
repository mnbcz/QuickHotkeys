...
(() => {
  ...
  // src/App.jsx
  var _tmpl$ = /* @__PURE__ */ template(`<div class=form><label for=video>Path to video:</label><div class=row><input type=text id=video><label class=custom-file-upload title="Select file">...</label></div><label for=time>Frame time (like 01:30.700), or path to thumbnail image:</label><div class=row><input type=text id=time><label class=custom-file-upload title="Select file">...</label></div><div class=row><button>Go</button></div><div class="row error"id=error>`);
  function App() {
    ...
    async function selectVideo(e) {
      let ahk = await window.chrome.webview.hostObjects.ahk;
      let selectedFile2 = await ahk.selectFile();
      document.querySelector("#video").value = selectedFile2;
    }
    async function selectThumbnail(e) {
      let ahk = await window.chrome.webview.hostObjects.ahk;
      let selectedFile2 = await ahk.selectFile();
      document.querySelector("#time").value = selectedFile2;
    }
    return (() => {
      var _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$3.nextSibling, _el$7 = _el$6.nextSibling, _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling, _el$10 = _el$7.nextSibling, _el$11 = _el$10.firstChild;
      _el$5.$$click = selectVideo;
      _el$9.$$click = selectThumbnail;
      _el$11.$$click = buttonClick;
      createRenderEffect(() => _el$4.value = selectedFile());
      return _el$;
    })();
  }
  var App_default = App;
