...
(() => {
  ...
  // src/App.jsx
  var _tmpl$ = /* @__PURE__ */ template(`<div class=listContainer>`);
  var _tmpl$2 = /* @__PURE__ */ template(`<img src=src/assets/loading.svg class=loading>`);
  var _tmpl$3 = /* @__PURE__ */ template(`<div class=row><div class=left></div><div class=right>`);
  var selectedFilesTest = ["D:\\D\\Video\\Favorite 3\\Apolonia and Little Caprice - First touch - XVIDEOSCOM.mp4", "D:\\D\\Video\\Favorite 3\\Cute brunette banged by big cocks - XVIDEOSCOM.mp4", "D:\\D\\Video\\Favorite 3\\Cute brunette banged by big cocks - XVIDEOSCOM.mp4"];
  function App() {
    const [selectedFiles, setSelectedFiles] = createSignal([]);
    onMount(async () => {
      let ahk = await window.chrome.webview.hostObjects.ahk;
      let selectedFiles2 = await ahk.selectedFiles;
      selectedFilesTest = await JSON.parse(selectedFiles2);
      ...
      insert(_el$, createComponent(For, {
        ...
        children: (fileItem, index) => (
          ...
          (() => {
            ...
            insert(_el$5, () => fileItem.path);
            createRenderEffect((_$p) => classList(_el$2, {
              "row green": fileItem.status == 1,
