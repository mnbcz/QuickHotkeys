...
(() => {
  ...
  // src/App.jsx
  var _tmpl$2 = /* @__PURE__ */ template(`<div class=wrapAll><main><a id=close></a><div class=header> </div><ul><li class=green>New version <!> available,  <a>Download</a></li><li class=green><a>What's new?</a></li></ul></main><footer>`);
  function App() {
    ...
    return (() => {
      var _el$ = _tmpl$2(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.firstChild, _el$6 = _el$4.nextSibling, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild, _el$12 = _el$8.nextSibling, _el$9 = _el$12.nextSibling, _el$11 = _el$9.nextSibling, _el$13 = _el$7.nextSibling, _el$14 = _el$13.firstChild, _el$15 = _el$2.nextSibling;
      _el$3.$$click = closeHdl;
      insert(_el$4, () => items().appName, _el$5);
      insert(_el$4, () => items().currentVersion, null);
      insert(_el$7, () => items().newVersion, _el$12);
      insert(_el$15, createComponent(Button$12, {
        variant: "primary",
        "class": "sendButton",
        onclick: closeButtonHdl,
        children: "Close "
      }));
      createRenderEffect((_p$) => {
        var _v$ = items().downloadUrl, _v$2 = items().newVersionUrl;
        _v$ !== _p$.e && setAttribute(_el$11, "href", _p$.e = _v$);
